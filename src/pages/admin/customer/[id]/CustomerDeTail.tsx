          ...
          <div className='flex flex-col'>
            ...
            <div className='mx-auto relative -mt-24'>
              ...
              <div className='text-center mt-3'>
                <h3 className='font-medium text-[#353535] mb-2 cursor-pointer'>Linda Blair</h3>
                <span className='text-[#3A5BFF] text-[14px] bg-customBlue px-[10px] py-1 rounded-md'>Active</span>
              </div>
            </div>
            ...
            <div className='px-4 mb-[18px]'>
              <div className='flex gap-2'>
                ...
                <div>
                  ...
                  <span className='text-[#353535] text-sm'>lindablair@mail.com</span>
                </div>
              </div>
            </div>
            <div className='px-4 mb-[18px]'>
              <div className='flex gap-2'>
                ...
                <div>
                  ...
                  <span className='text-[#353535] text-sm'>1833 Bel Meadow Drive, Fontana, California 92335, USA</span>
                </div>
              </div>
            </div>
            <div className='px-4 mb-[18px]'>
              <div className='flex gap-2'>
                ...
                <div>
                  ...
                  <span className='text-[#353535] text-sm'>050 414 8778</span>
                </div>
              </div>
            </div>
            <div className='px-4 mb-[18px]'>
              ...
              <div className='flex item-center justify-between '>
                <div className='p-2 bg-customBlue rounded-lg flex items-center justify-center'>
                  <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 20 20' fill='none'>
                    <g clip-path='url(#clip0_5240_706)'>
                      <path
            ...
            <div className='px-4 py-3 rounded-xl shadow-md'>
              <div className='flex item-center justify-between'>
                <div className='p-2 bg-customYellow rounded-lg flex items-center justify-center'>
                  <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 20 20' fill='none'>
                    <g clip-path='url(#clip0_5240_1043)'>
                      <path
