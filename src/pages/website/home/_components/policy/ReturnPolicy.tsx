              ...
              <div className='wrapbox-content-page'>
                <div className='content-page '>
                  ...
                  <p className='mt-[0.6em] mb-[0.6em] text-[#666] block'>
                    ...
                    lắp đặt từ phía CozyNet.
                  </p>
                  <p className='mt-[0.6em] mb-[0.6em] text-[#666] block'>
                    - Đổi sang sản phẩm khác bằng giá trị hoặc có giá trị cao hơn sản phẩm đã giao.
                  </p>
                  <p className='mt-[0.6em] mb-[0.6em] text-[#666] block'>
                    Sau 3 ngày tính từ ngày giao hàng thành công, CozyNet sẽ áp dụng sang chính sách bảo hành cho các
                    sản phẩm bị hư hỏng do lỗi chất liệu, lỗi kỹ thuật và lỗi lắp đặt từ phía CozyNet, không áp dụng đổi
                    sang sản phẩm khác.
                  </p>
                  <p className='mt-[0.6em] mb-[0.6em] text-[#666] block'>
                    ...
                    thay đổi ý kiến, nhưng phải thanh toán phí giao hàng cho CozyNet là 300,000đ và chi phí lắp đặt tùy
