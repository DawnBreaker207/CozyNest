              ...
              <div className='wrapbox-content-page'>
                <div className='content-page '>
                  <p className='mt-[1em] mb-[1em] text-[#666] block'>
                    ...
                    CozyNet sẽ không hoàn lại 1,000,000đ đã đặt cọc.
                  </p>
                  <p className='mt-[1em] mb-[1em] text-[#666] block'>
                    - Trong trường hợp quý khách hàng không thanh toán ngay phần giá trị còn lại của đơn hàng khi nhận
                    hàng, CozyNet sẽ thu hồi số sản phẩm tương ứng với số tiền chưa thanh toán và quý khách hàng vui
                    lòng thanh toán phí giao hàng cho CozyNet là 300,000đ cho các khu vực miễn phí giao hàng.
                  </p>
                  <p className='mt-[1em] mb-[1em] text-[#666] block'>
                  ...
                  <p className='mt-[1em] mb-[1em] text-[#666] block'>
                    - Nếu quý khách hàng có nhu cầu xuất hóa đơn vui lòng thông báo cho CozyNet ngay lúc đặt hàng. Hóa
                    đơn đã xuất không thể chỉnh sửa hoặc hủy và xuất lại. Sau thời điểm đặt hàng 24 tiếng CozyNet sẽ
                    không nhận xuất hóa đơn. Hóa đơn xuất theo yêu cầu của quý khách hàng sẽ được gửi đến quý khách hàng
                    trong vòng 7 ngày kể từ ngày giao hàng thành công, không tính thứ 7, chủ nhật và các ngày lễ, tết.
                  </p>
                  <p className='mt-[1em] mb-[1em] text-[#666] block'>
                  ...
                  <p className='mt-[1em] mb-[1em] text-[#666] block'>
                    ...
                    hàng, quý khách hàng vui lòng thanh toán phí lưu kho cho CozyNet là 10% giá trị đơn hàng.
                  </p>
                  <p className='mt-[1em] mb-[1em] text-[#666] block'>
                    - Quyết định của Nội Thất CozyNet là quyết định cuối cùng và có thể thay đổi mà không cần thông báo
                    trước.&nbsp;
                  </p>
                  <p className='mt-[1em] mb-[1em] text-[#666] block'>
