          ...
          <div className='col-md-12 col-sm-12 col-xs-12 col-md-push-0'>
            <div className='page-wrapper'>
              <div className='heading-page'>
                <b className='text-[1.8em] block'>Khách Hàng Thân Thiết – CozyNest</b>
              </div>
              <div className='wrapbox-content-page'>
                <div className='content-page '>
                  ...
                  <p className='mt-[0.6em] mb-[0.6em] text-[#666] block'>
                    - Điểm tích lũy sẽ bị xóa sau 365 ngày quý khách hàng không phát sinh đơn hàng mới&nbsp;hoặc có phát
                  ...
                  <p className='mt-[0.6em] mb-[0.6em] text-[#666] block'>
                    - Giới hạn sửa dụng 1 lần/ mỗi khách hàng trong thời gian diễn ra khuyến mãi
                  </p>
                  <p className='mt-[0.6em] mb-[0.6em] text-[#666] block'>
                    - Voucher chỉ áp dụng hợp lệ với khách hàng đang là khách hàng thân thiết tính tới thời điểm đặt đơn
                    hàng.
                  </p>
                </div>
              </div>
